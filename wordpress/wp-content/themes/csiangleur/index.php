    ...
    <div class="headContent__cards">
      <div class="headContent__cardsContact">
        ...
        <ul class="cards__list" itemscope itemtype="http://schema.org/Organization">
          ...
          <li class="cards__element"><a class="cards__link" href="mailto:<?php the_field('email', 'option');?>" title="Nous envoyer un email"><span class="cards__label cards__label--email">Email : </span><span class="cards__info" itemprop="email"><?php the_field('email', 'option');?></span></a></li>
        </ul>
      </div>

...
<![endif]-->
    <meta charset="utf-8">
    <meta name="description" content="CSI Angleur | Maison médicale basé à Angleur, Belgique">
      ...
      <div class="site-pusher">
        <header class="header">
          <div class="header__content">
            <h1 class="header__logo"><a class="header__logolink" href="index.html"><img class="header__img" src="<?php echo get_template_directory_uri().'/images/svg/logo.svg';?>" width="121" height="72"><span class="hidden">CSI Angleur - Accueil</span></a></h1>
